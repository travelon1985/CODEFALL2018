...
def binner(reader, favoriteMatrix, awayMatrix):
  ...
  print ("This is the away matrix:")
  print (awayMatrix)
  print ("This is the favorite matrix:")
...
def profitBinner(reader, favoriteProfitMatrix, awayProfitMatrix):
  ...
  print("This is the away profit matrix:")
  print(awayProfitMatrix)
  print("This is the favorite profit matrix:")
  print(favoriteProfitMatrix)
      #away
      #if row[7] > .5:
