...
def awayCountBinnerADDALL(reader):
  counter = 0
  matchCounter = 0
  rowCounter = 0
  for row in islice(reader, 1, None):
      ...
      if float(row[7]) > 0.5:
        ...
        if float(row[7]) > .5 and float(row[7]) < .6:
          ...
          if float(row[18]) < 1 and float(row[18]) > 0.89:
            favoriteMatrixA[0][0] = favoriteMatrixA[0][0] + 1
            
          #less than .90 so .89 and greater than .79 so .80
          elif float(row[18]) < 0.90 and float(row[18]) > .79:
            favoriteMatrixA[1][0] = favoriteMatrixA[1][0] + 1
            
          elif float(row[18]) < 0.80 and float(row[18]) > .69:
            favoriteMatrixA[2][0] = favoriteMatrixA[2][0] + 1
            
          elif float(row[18]) < 0.70 and float(row[18]) > .59:
            favoriteMatrixA[3][0] = favoriteMatrixA[3][0] + 1
            
          elif float(row[18]) < 0.60 and float(row[18]) > .49:
            favoriteMatrixA[4][0] = favoriteMatrixA[4][0] + 1
            
          elif float(row[18]) < 0.50 and float(row[18]) > .39:
            favoriteMatrixA[5][0] = favoriteMatrixA[5][0] + 1
          
          elif float(row[18]) < 0.40 and float(row[18]) > .29:
            favoriteMatrixA[6][0] = favoriteMatrixA[6][0] + 1
        ...
        if float(row[7]) > .59 and float(row[7]) < .7:
          ...
          #less than 1 so .99 and greater than .89 so .90
          if float(row[18]) < 1 and float(row[18]) > 0.89:
            favoriteMatrixA[0][1] = favoriteMatrixA[0][1] + 1
            
          #less than .90 so .89 and greater than .79 so .80
          elif float(row[18]) < 0.90 and float(row[18]) > .79:
            favoriteMatrixA[1][1] = favoriteMatrixA[1][1] + 1
            
          elif float(row[18]) < 0.80 and float(row[18]) > .69:
            favoriteMatrixA[2][1] = favoriteMatrixA[2][1] + 1
            
          elif float(row[18]) < 0.70 and float(row[18]) > .59:
            favoriteMatrixA[3][1] = favoriteMatrixA[3][1] + 1
            
          elif float(row[18]) < 0.60 and float(row[18]) > .49:
            favoriteMatrixA[4][1] = favoriteMatrixA[4][1] + 1
            
          elif float(row[18]) < 0.50 and float(row[18]) > .39:
            favoriteMatrixA[5][1] = favoriteMatrixA[5][1] + 1
          
          elif float(row[18]) < 0.40 and float(row[18]) > .29:
            favoriteMatrixA[6][1] = favoriteMatrixA[6][1] + 1
        ...
        if float(row[7]) > .69 and float(row[7]) < .8:
          ...
          #less than 1 so .99 and greater than .89 so .90
          if float(row[18]) < 1 and float(row[18]) > 0.89:
            favoriteMatrixA[0][2] = favoriteMatrixA[0][2] + 1
            
          #less than .90 so .89 and greater than .79 so .80
          elif float(row[18]) < 0.90 and float(row[18]) > .79:
            favoriteMatrixA[1][2] = favoriteMatrixA[1][2] + 1
            
          elif float(row[18]) < 0.80 and float(row[18]) > .69:
            favoriteMatrixA[2][2] = favoriteMatrixA[2][2] + 1
            
          elif float(row[18]) < 0.70 and float(row[18]) > .59:
            favoriteMatrixA[3][2] = favoriteMatrixA[3][2] + 1
            
          elif float(row[18]) < 0.60 and float(row[18]) > .49:
            favoriteMatrixA[4][2] = favoriteMatrixA[4][2] + 1
            
          elif float(row[18]) < 0.50 and float(row[18]) > .39:
            favoriteMatrixA[5][2] = favoriteMatrixA[5][2] + 1
          
          elif float(row[18]) < 0.40 and float(row[18]) > .29:
            favoriteMatrixA[6][2] = favoriteMatrixA[6][2] + 1
        ...
        if float(row[7]) > .79 and float(row[7]) < .9:
          ...
          #less than 1 so .99 and greater than .89 so .90
          if float(row[18]) < 1 and float(row[18]) > 0.89:
            favoriteMatrixA[0][3] = favoriteMatrixA[0][3] + 1
            
          #less than .90 so .89 and greater than .79 so .80
          elif float(row[18]) < 0.90 and float(row[18]) > .79:
            favoriteMatrixA[1][3] = favoriteMatrixA[1][3] + 1
            
          elif float(row[18]) < 0.80 and float(row[18]) > .69:
            favoriteMatrixA[2][3] = favoriteMatrixA[2][3] + 1
            
          elif float(row[18]) < 0.70 and float(row[18]) > .59:
            favoriteMatrixA[3][3] = favoriteMatrixA[3][3] + 1
            
          elif float(row[18]) < 0.60 and float(row[18]) > .49:
            favoriteMatrixA[4][3] = favoriteMatrixA[4][3] + 1
            
          elif float(row[18]) < 0.50 and float(row[18]) > .39:
            favoriteMatrixA[5][3] = favoriteMatrixA[5][3] + 1
          
          elif float(row[18]) < 0.40 and float(row[18]) > .29:
            favoriteMatrixA[6][3] = favoriteMatrixA[6][3] + 1
        ...
        if float(row[7]) > .89 and float(row[7]) < 1:
          ...
          #less than 1 so .99 and greater than .89 so .90
          if float(row[18]) < 1 and float(row[18]) > 0.89:
            favoriteMatrixA[0][4] = favoriteMatrixA[0][4] + 1
            
          #less than .90 so .89 and greater than .79 so .80
          elif float(row[18]) < 0.90 and float(row[18]) > .79:
            favoriteMatrixA[1][4] = favoriteMatrixA[1][4] + 1
            
          elif float(row[18]) < 0.80 and float(row[18]) > .69:
            favoriteMatrixA[2][4] = favoriteMatrixA[2][4] + 1
            
          elif float(row[18]) < 0.70 and float(row[18]) > .59:
            favoriteMatrixA[3][4] = favoriteMatrixA[3][4] + 1
            
          elif float(row[18]) < 0.60 and float(row[18]) > .49:
            favoriteMatrixA[4][4] = favoriteMatrixA[4][4] + 1
            
          elif float(row[18]) < 0.50 and float(row[18]) > .39:
            favoriteMatrixA[5][4] = favoriteMatrixA[5][4] + 1
          
          elif float(row[18]) < 0.40 and float(row[18]) > .29:
            favoriteMatrixA[6][4] = favoriteMatrixA[6][4] + 1
  
  print ("done away")          
  print (favoriteMatrixA)
...
def heatMapGenerator(favoriteMatrix):
  ...
  data = [trace]
  py.iplot(data, filename = 'basic-heatmap-home')

def heatMapGeneratorAway(favoriteMatrixA):
  trace = go.Heatmap(z=favoriteMatrixA)
  data = [trace]
  py.iplot(data, filename = 'basic-heatmap-away')

def heatMapGeneratorAll(favoriteMatrix):
  trace = go.Heatmap(z=favoriteMatrix)
  data = [trace]
  py.iplot(data, filename = 'basic-heatmap-home-and-away')
