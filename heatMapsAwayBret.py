...
#five thirty eight away prob between .90 and 1 (>.89999 and <1)
...
def heatMapGenerators(favoriteMatrix,awayMatrix, favoriteProfitMatrix, awayProfitMatrix):
  ...
  py.iplot(dataAway, filename = 'AwayCountV3')  
  py.iplot(dataHomeProf, filename = 'HomeProfitV2')
  py.iplot(dataAwayProf, filename = 'AwayProfitV2')  
